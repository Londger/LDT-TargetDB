...
Among the 200 top-ranked targets, multi-dimensional validation supported biological plausibility: of the top 30 targets queried in Open Targets, 21 had cancer-associated disease annotations; all of the top 20 targets queried in Ensembl Compara were conserved across >=5 model organisms; Low mutation frequencies were observed in the TCGA pan-cancer dataset (no top-ranked target showed mutations across all 37 TCGA cohorts; the most mutationally stable target had zero detected mutations across all cohorts, while the most frequently mutated target had detectable mutations in 32 of 37 cohorts); and GO enrichment of the top 30 targets identified 20 significantly enriched biological process terms (FDR < 0.05), predominantly related to cell adhesion, transmembrane transport, and epithelial development.
